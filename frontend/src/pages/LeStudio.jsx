...
import { equipment, principles, services, galleryImages, aboutImage, siteInfo } from "../mock";
      ...
      <section className="py-24 md:py-32 bg-[#f2ebdf] px-6 md:px-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            {equipment.map((e, i) => (
              <div key={i} className="reveal border-t border-[#c9bda4] pt-8" style={{ transitionDelay: `${i * 80}ms` }}>
      ...
      <section className="py-24 md:py-32 px-6 md:px-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((s, i) => (
              <div key={i} className="reveal bg-[#f2ebdf] p-10 group hover:bg-[#2c2520] hover:text-[#faf7f2] transition-colors duration-500" style={{ transitionDelay: `${i * 80}ms` }}>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20 reveal">
            ...
            <h2 className="font-serif text-4xl md:text-5xl">
              Les six principes <em className="italic font-light">du Pilates</em>
            </h2>
          </div>
